...
<div class="text-center mb-3">
  <a class="btn btn-primary text-center" href="https://github.com/anon-auth-2o/SiLVi/releases/download/v0.5.2-alpha/SiLVi-0.5.2-arm64.dmg" role="button"><i class="bi bi-apple"></i> Download for macOS ARM64</a>
</div>

<div class="text-center mb-3">
  <a class="btn btn-primary text-center" href="https://github.com/anon-auth-2o/SiLVi/releases/download/v0.5.2-alpha/SiLVi-0.5.2-x64.dmg" role="button"><i class="bi bi-apple"></i> Download for macOS x64</a>
</div>
