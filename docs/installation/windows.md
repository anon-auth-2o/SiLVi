...
<div class="text-center mb-3">
  <a class="btn btn-primary text-center" href="https://github.com/anon-auth-2o/SiLVi/releases/download/v0.5.2-alpha/SiLVi-0.5.2.Setup.exe" role="button"><i class="bi bi-windows"></i> Download for Windows</a>
</div>
