...
<div class="text-center mb-3">
  <a class="btn btn-primary" href="https://github.com/ecker-lab/SiLVi/releases/download/v0.5.2-alpha/silvi_0.5.2_arm64.deb" role="button"><i class="bi bi-ubuntu"></i> Download for Debian/Ubuntu ARM64</a>
</div>
